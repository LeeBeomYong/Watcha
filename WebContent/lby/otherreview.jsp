	...
	<div id="root">
		<div id ="sub">
			...
			<hr>
				<br>
				<div class="add">
					<a href="<%=request.getContextPath() %>/otherreview_add.do?member_id=<%=request.getParameter("member_id")%>" style="text-decoration: none; color: red;"><span>더보기</span></a>
				</div>
				<div>
			...
			<hr>
				<div>
					<div>
						<a class="hw" href="<%=request.getContextPath() %>/otherheart_add.do?member_id=<%=request.getParameter("member_id")%>" style="text-decoration: none; color: black;"><h3><strong>보고싶어요</strong></h3></a>
					</div>
			...
			<hr>
				<div>
					<div>
						<a class="hw" href="<%=request.getContextPath() %>/otherwatch_add.do?member_id=<%=request.getParameter("member_id")%>" style="text-decoration: none; color: black;"><h3><strong>보는중</strong></h3></a>
					</div>
					<div style="text-align: right; margin-top: -30px; margin-right: 40px;">
