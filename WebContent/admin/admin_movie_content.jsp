       ...
       <div  class="can-1">
          <fieldset>
           <legend><span class="number">1</span>영화사진</legend>
             ...
             <img src="<%=request.getContextPath()%>/image/${dto.getMovie_video()}" width="150" height="200" > 
             	<div class="file">
             	<input type="file" name="movie_new_video">
        ...
        <fieldset >
          ...
          <input type="text" id="name" name="movie_title"  value="${dto.getMovie_num() }">
        </fieldset>
